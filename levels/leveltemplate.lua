-- TODO template for level screen
...
function scene:createScene( event )
	print("Scene created: leveltemplate")
...
function scene:enterScene( event )
	print("Scene viewed: leveltemplate")
	local group = self.view
...
function scene:exitScene( event )
	print("Scene closed: leveltemplate")
	local group = self.view
...
function scene:destroyScene( event )
	print("Scene destroyed: leveltemplate")
	local group = self.view
