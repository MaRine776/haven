-- TODO template for dialogue screen

----------------------------------------------------------------------------------
--
-- dailoguetemplate.lua
--
----------------------------------------------------------------------------------
...
function scene:createScene( event )
	print("Scene created: dailoguetemplate")
...
function scene:enterScene( event )
	print("Scene viewed: dailoguetemplate")
	local group = self.view
...
function scene:exitScene( event )
	print("Scene closed: dailoguetemplate")
	local group = self.view
...
function scene:destroyScene( event )
	print("Scene destroyed: dailoguetemplate")
	local group = self.view
